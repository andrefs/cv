...
\item [2010/present] 2${^\textrm{st}}$ year of Software Engineering MSc, University of Minho
	\begin{itemize}
		...
		Development of a system to support automatic handling of corpora (cleaning, validation, format conversion), alignment and alignability calculus of several types of documents, as well as make them available on the internet.
	\end{itemize}
\end{description}
